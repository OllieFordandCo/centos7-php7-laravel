...
RUN yum -y update && yum -y install php56w php56w-mysql php56w-xml php56w-mbstring php56w-pdo php56w-gd php56w-mcrypt php56w-opcache newrelic-sysmond newrelic-php5 && yum -y clean all 
